...
import { Camera, Search, Download, Save } from 'lucide-react';
  ...
  return (
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        ...
        {/* Demo Section */}
        <Card className="max-w-4xl mx-auto bg-gradient-to-br from-pink-50 to-orange-50 border-0 shadow-xl">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl font-bold text-gray-800">
              Try FindMyFace Demo
            </CardTitle>
            <p className="text-gray-600">
              Experience our AI face recognition technology
            </p>
          </CardHeader>
          <CardContent className="text-center">
            <div className="bg-white rounded-2xl p-8 mb-6 shadow-inner">
              ...
              <Button className="bg-gradient-to-r from-pink-500 to-orange-500 hover:from-pink-600 hover:to-orange-600 text-white px-8 py-3 rounded-full">
                <Camera className="mr-2 h-5 w-5" />
                Start Camera
              </Button>
            </div>
            <p className="text-sm text-gray-500">
              Note: This demo requires camera permissions and an active event to search through
            </p>
          </CardContent>
        </Card>
